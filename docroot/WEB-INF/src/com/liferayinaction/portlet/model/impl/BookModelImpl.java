...
import com.liferayinaction.portlet.model.BookModel;
import com.liferayinaction.portlet.model.BookSoap;
...
/**
 * The base model implementation for the Book service. Represents a row in the &quot;namespaceant_Book&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This implementation and its corresponding interface {@link com.liferayinaction.portlet.model.BookModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link BookImpl}.
 * </p>
 *
 * @author augello
 * @see BookImpl
 * @see com.liferayinaction.portlet.model.Book
 * @see com.liferayinaction.portlet.model.BookModel
 * @generated
 */
@JSON(strict = true)
public class BookModelImpl extends BaseModelImpl<Book> implements BookModel {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. All methods that expect a book model instance should use the {@link com.liferayinaction.portlet.model.Book} interface instead.
	 */
	public static final String TABLE_NAME = "namespaceant_Book";
	public static final Object[][] TABLE_COLUMNS = {
			{ "bookId", Types.BIGINT },
			{ "title", Types.VARCHAR },
			{ "isbn", Types.VARCHAR }
		};
	public static final String TABLE_SQL_CREATE = "create table namespaceant_Book (bookId LONG not null primary key,title VARCHAR(75) null,isbn VARCHAR(75) null)";
	public static final String TABLE_SQL_DROP = "drop table namespaceant_Book";
	public static final String DATA_SOURCE = "liferayDataSource";
	public static final String SESSION_FACTORY = "liferaySessionFactory";
	public static final String TX_MANAGER = "liferayTransactionManager";
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.entity.cache.enabled.com.liferayinaction.portlet.model.Book"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.finder.cache.enabled.com.liferayinaction.portlet.model.Book"),
			true);
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.util.service.ServiceProps.get(
				"lock.expiration.time.com.liferayinaction.portlet.model.Book"));
